...
tags:
  ...
  - method/recurrence
---
<!-- AUTOGENERATED by scripts/sync_vault.py from "backend/data/vaults/spring2026/networks/topics/12 Preferential Attachment.md". DO NOT EDIT — edit the vault note and re-run: python3 scripts/sync_vault.py -->

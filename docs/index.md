...
### Networks
Graph/network algorithms beyond the basic.  
...
- **Starting from scratch?**  
  Begin with **Topics → Data Structures**, then move into **Efficient Algorithms**.

- **Brushing up for interviews / research / work?**  
  Jump between **Data Structures / Efficient Algorithms** and the **Resources** section.
